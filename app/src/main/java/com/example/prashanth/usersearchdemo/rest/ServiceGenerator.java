...
import com.example.prashanth.usersearchdemo.rest.httpconverters.HttpConverterFactory;
...
public class ServiceGenerator {
    ...
    private static String sAccessToken = "tmInNG2jaM9SW1vqFKHSa9l6e0bpuVO01z3CESQc";
        ...
        httpClient.addInterceptor(new Interceptor() {
            ...
            public Response intercept(Chain chain) throws IOException {
                ...
                if(sAccessToken != null && !sAccessToken.isEmpty()){
                    requestBuilder = requestBuilder.header("x-api-key", sAccessToken);
                } else {
                    requestBuilder = requestBuilder.removeHeader("x-api-key");
                }
